  ...
  override def fingerprints(): Array[sbtt.Fingerprint] = {
    def mkFP(mod: Boolean, cname: String): sbtt.SubclassFingerprint =
      new sbtt.SubclassFingerprint {
        override def superclassName(): String = cname
        override def isModule(): Boolean = mod
...
class Runner(
  ...
  , val _remoteArgs: Array[String]
  , testClassLoader: ClassLoader
  ) extends sbtt.Runner {

  @inline override def remoteArgs(): Array[String] = _remoteArgs
...
class Task(
    val _taskDef: sbtt.TaskDef
  , fingerprint: sbtt.SubclassFingerprint
  , testClassLoader: ClassLoader
  ) extends _root_.sbt.testing.Task {

  @inline override def taskDef(): sbtt.TaskDef = _taskDef
...
case class Event(
 ...
 , _fingerprint: sbtt.Fingerprint
 , _selector: sbtt.Selector
 , _status: sbtt.Status
 , throwableO: Option[Throwable]
 , _duration: Long
 ) extends sbtt.Event {

  @inline override def fullyQualifiedName(): String = _fullyQualifiedName

  @inline override def fingerprint(): sbtt.Fingerprint = _fingerprint

  @inline override def selector(): sbtt.Selector = _selector

  @inline override def status(): sbtt.Status = _status

  @inline override def duration(): Long = _duration
